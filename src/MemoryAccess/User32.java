...
public interface User32 extends W32APIOptions {
    ...
    public static class FLASHWINFO extends Structure {
        ...
        protected List getFieldOrder() {
            ...
            fields.addAll(Arrays.asList(new String[]{"cbSize", "hWnd", "dwFlags", "uCount", "dwTimeout"}));
            return fields;
        }
    }
    int IMAGE_BITMAP = 0;
    ...
    public static class GUITHREADINFO extends Structure {
        ...
        protected List getFieldOrder() {
            List fields = new ArrayList();
            fields.addAll(Arrays.asList(new String[]{"cbSize", "flags", "hwndActive", "hwndFocus", "hwndCapture", "hwndMenuOwner", "hwndMoveSize", "hwndCaret", "rcCaret"}));
            return fields;
        }
    }
    ...
    public static class WINDOWINFO extends Structure {
        ...
        protected List getFieldOrder() {
            List fields = new ArrayList();
            fields.addAll(Arrays.asList(new String[]{"cbSize", "rcWindow", "rcClient", "dwStyle", "dwExStyle", "dwWindowStatus", "cxWindowBorders", "cyWindowBorders", "atomWindowType","wCreatorVersion"}));
            return fields;
        }
    }
    ...
    public static class POINT extends Structure {
        ...
        protected List getFieldOrder() {
            List fields = new ArrayList();
            fields.addAll(Arrays.asList(new String[]{"x", "y"}));
            return fields;
        }
    }
    ...
    public static class SIZE extends Structure {
        ...
        protected List getFieldOrder() {
            List fields = new ArrayList();
            fields.addAll(Arrays.asList(new String[]{"cx", "cy"}));
            return fields;
        }
    }
    ...
    public static class BLENDFUNCTION extends Structure {
        ...
        protected List getFieldOrder() {
            List fields = new ArrayList();
            fields.addAll(Arrays.asList(new String[]{"BlendOp", "BlendFlags","SourceConstantAlpha","AlphaFormat"}));
            return fields;
        }
    }
